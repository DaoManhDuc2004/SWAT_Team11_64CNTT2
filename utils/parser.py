...
def parse_args():
    ...
    # ImageNet OOD
    parser.add_argument('--test_imagenet_ood', default=False, action='store_true', help='test on imagenet ood.')
    ...
    args.fewshot_data = [[f'fewshot{args.shots}_seed{args.seed}.txt'], [args.dataset_path]]
    args.retrieval_data = [[args.retrieval_split], [args.retrieved_path]]
    args.val_split = [[f'fewshot{args.shots}_seed{args.seed}.txt'], [args.dataset_path]]
    args.test_split = [['test.txt'], [args.dataset_path]]

    if args.data_source == 'fewshot':
        args.train_split = [[f'fewshot{args.shots}_seed{args.seed}.txt'], [args.dataset_path]]

    elif args.data_source == 'retrieved':
        args.train_split = [[args.retrieval_split], [args.retrieved_path]]

    elif args.data_source == 'fewshot+retrieved':
        args.train_split = [[f'fewshot{args.shots}_seed{args.seed}.txt', args.retrieval_split],
                            [args.dataset_path, args.retrieved_path]]
